          ...
          <div className="container">
            <div className="about-content">
              <div className="about-text">
                ...
                <p>ResumeCraft был основан в 2018 году командой HR-специалистов и разработчиков, которые заметили проблему: большинство соискателей используют устаревшие шаблоны резюме, которые не проходят через системы автоматического отбора (ATS).</p>
